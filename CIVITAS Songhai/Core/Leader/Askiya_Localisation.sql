...
-----------------------------------------------	
	...
	("LOC_LEADER_CVS_ASKIYA_NAME",  	"Askiya"	),
	
-----------------------------------------------
-- UA
-----------------------------------------------	

	("LOC_TRAIT_LEADER_CVS_ASKIYA_UA_NAME",  	"By Fire And Sword"	),
	("LOC_TRAIT_LEADER_CVS_ASKIYA_UA_DESCRIPTION",		
	"Receive +1 [ICON_Science] Science for each City that follows Askiya's [ICON_Religion] Religion. Cavalry Units trained in Cities at full Loyalty start with a free [ICON_Promotion] Promotion. Gains access to the Kaburoo unique building."),

-----------------------------------------------
-- UI
-----------------------------------------------

	("LOC_BUILDING_CVS_ASKIYA_UI_NAME",		"Kaburoo"	),
	("LOC_BUILDING_CVS_ASKIYA_UI_DESCRIPTION",		
	"Exerts +2 Loyalty Pressure, and Religious units trained in this city earn +75 [ICON_Science] Science upon converting a city to their [ICON_Religion] Religion for the first time."	),

-----------------------------------------------
-- Agenda
-----------------------------------------------	

	("LOC_AGENDA_CVS_ASKIYA_NAME",		"Ulama"	),
	("LOC_AGENDA_CVS_ASKIYA_DESCRIPTION", 	"Respects civilizations with a strong economy and powerful military. Dislikes those that neglect education."	),
	("LOC_DIPLO_KUDO_LEADER_CVS_ASKIYA_REASON_ANY",			  
	"(You have a strong economy and powerful military.)"	),
	("LOC_DIPLO_MODIFIER_CVS_ASKIYA_HAPPY",		
	"Askiya is pleased with your strong economy and powerful military"	),
	("LOC_DIPLO_WARNING_LEADER_CVS_ASKIYA_REASON_ANY",		  
	"(You have neglected education.)"	),
	("LOC_DIPLO_MODIFIER_CVS_ASKIYA_UNHAPPY",			 
	"Askiya is unhappy that you have neglected education"	),
...
-- DOM
	("LOC_LOADING_INFO_LEADER_CVS_ASKIYA",  	
	"May the blessings of God be upon you Askiya, Great King of Songhai. By fire and sword, the time has come to forge the destiny of your kingdom. Unite the faithful, expand your trade on rivers of gold, and with it bring wealth and prosperity to your scholars as they boldy tend the flame of progress."  	),

-- FIRST MEET
	-- First AI Line
	("LOC_DIPLO_FIRST_MEET_LEADER_CVS_ASKIYA_ANY",		
	"Greetings. I am Askiya of the Songhai. We are a fair people, but those who cross us will only find destruction. You would do well to tread where others have stumbled." ),
	
	-- AI invitation to visit nearby City
	("LOC_DIPLO_FIRST_MEET_VISIT_RECIPIENT_LEADER_CVS_ASKIYA_ANY",		
	"Our city is close by. Come, speak with my scholars and we can discuss trade later."	),
	
	-- AI accepts human invitation
	("LOC_DIPLO_FIRST_MEET_NEAR_INITIATOR_POSITIVE_LEADER_CVS_ASKIYA_ANY",		
	"If I must."	),
	
	-- AI invitation to exchange Capital Information
	("LOC_DIPLO_FIRST_MEET_NO_MANS_INFO_EXCHANGE_LEADER_CVS_ASKIYA_ANY",		
	"Shall we exchange information on our capitals to promote trade between our people?"	),

-- GREETINGS	
	("LOC_DIPLO_GREETING_LEADER_CVS_ASKIYA_ANY",		
	"Proceed."	),
	
-- DELEGATION
	-- AI Accepts
	("LOC_DIPLO_ACCEPT_DELEGATION_FROM_HUMAN_LEADER_CVS_ASKIYA_ANY",		
	"Very well."	),
	
	-- AI Rejects
	("LOC_DIPLO_REJECT_DELEGATION_FROM_HUMAN_LEADER_CVS_ASKIYA_ANY",		
	"Not today."	),
	
	-- AI Requests
	("LOC_DIPLO_DELEGATION_FROM_AI_LEADER_CVS_ASKIYA_ANY",		
	"I have sent gifts of kola nuts, salt and gold. I trust that you will extend to my delegates the same respect you have shown me."	),
	
-- OPEN BORDERS
	-- AI accepts from human	
	("LOC_DIPLO_ACCEPT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_ASKIYA_ANY",	
	"For now, but I am not always this generous."	),
	
	-- AI rejects from human	
	("LOC_DIPLO_REJECT_OPEN_BORDERS_FROM_HUMAN_LEADER_CVS_ASKIYA_ANY",  
	"I don't think so."	),
	
	-- AI requests from human	
	("LOC_DIPLO_OPEN_BORDERS_FROM_AI_LEADER_CVS_ASKIYA_ANY",      
	"My people need to cross your borders. Will you extend us this courtesy?"	),
	
-- DECLARE FRIENDSHIP

	-- AI accepts from human	
	("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_ASKIYA_ANY",   
	"Very well."	),
	
	-- AI rejects from human	
	("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_HUMAN_LEADER_CVS_ASKIYA_ANY",   
	"A patient man will eat ripe fruit. Give it time."	),
	
	-- AI Requests friendship from human	
	("LOC_DIPLO_DECLARE_FRIEND_FROM_AI_LEADER_CVS_ASKIYA_ANY",     
	"Where there are scholars, there will be students. Let there be friendship between us."	),
	
	-- Human accepts AI requests, AI responds	
	("LOC_DIPLO_ACCEPT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_ASKIYA_ANY",           
	"Thank you."	),
	
	-- Human rejects AI requests, AI responds	
	("LOC_DIPLO_REJECT_DECLARE_FRIEND_FROM_AI_LEADER_CVS_ASKIYA_ANY",   	
	"Foolish."	),

-- ALLIANCE

	-- AI Requests an alliance from human
	("LOC_DIPLO_MAKE_ALLIANCE_FROM_AI_LEADER_CVS_ASKIYA_ANY",		
	"With the sword I draw, I ask no omen but my kingdom's cause. We shall fight stronger as allies, wouldn't you agree?"	),

-- KUDOS & WARNINGS
	
	-- AI Kudos
	("LOC_DIPLO_KUDO_EXIT_LEADER_CVS_ASKIYA_ANY",		
	"Talent is but a flame; education is the fire. You have my respect."	),
	
	-- AI Warnings
	("LOC_DIPLO_WARNING_EXIT_LEADER_CVS_ASKIYA_ANY",		
	...
	("LOC_DIPLO_WARNING_TOO_MANY_TROOPS_NEAR_ME_LEADER_CVS_ASKIYA_ANY",		
	"I've heard whispers of your troops stationed along my borders. If fire and destruction is what you seek, I shall bring it to you. If it is not, move."	),

-- TRADE
	
	-- AI Accepts Deal
	("LOC_DIPLO_ACCEPT_MAKE_DEAL_FROM_AI_LEADER_CVS_ASKIYA_ANY",		
	"This will do."	),

	-- AI Rejects Deal
	("LOC_DIPLO_REJECT_MAKE_DEAL_FROM_AI_LEADER_CVS_ASKIYA_ANY",		
	"Try again."	),

-- DENOUNCE
	
	-- From Human
	("LOC_DIPLO_DENOUNCE_FROM_HUMAN_LEADER_CVS_ASKIYA_ANY",		
	"It is unwise to insult a crocodile before you cross the river."	),
	
	-- From AI
	("LOC_DIPLO_DENOUNCE_FROM_AI_LEADER_CVS_ASKIYA_ANY",		
	"One can easily forgive those afraid of the dark. It is but a tragedy that you are afraid of the light. (Denounces You)"	),
	
-- DOW
	
	-- Human Declares War
	("LOC_DIPLO_DECLARE_WAR_FROM_HUMAN_LEADER_CVS_ASKIYA_ANY",		
	"I have seen the flames and walked through the fire, for this is not my first battle, but it may well be your last."	),
	
	-- AI Declares War
	("LOC_DIPLO_DECLARE_WAR_FROM_AI_LEADER_CVS_ASKIYA_ANY",		
	"A choice has been made. However long the night, the dawn will break, and when it does I shall walk upon the ashes of your fallen."	), 

-- MAKE PEACE
	
	-- AI accepts from human
	("LOC_DIPLO_MAKE_PEACE_AI_ACCEPT_DEAL_LEADER_CVS_ASKIYA_ANY",		
	"I agree. Peace is costly, but perhaps it is worth the expense."	),
	
	-- AI refuses human
	("LOC_DIPLO_MAKE_PEACE_AI_REFUSE_DEAL_LEADER_CVS_ASKIYA_ANY",		
	...
	-- AI requests from human
	("LOC_DIPLO_MAKE_PEACE_FROM_AI_LEADER_CVS_ASKIYA_ANY",		
...
-- DEFEAT
	...
	("LOC_DIPLO_DEFEAT_FROM_HUMAN_LEADER_CVS_ASKIYA_ANY",		
	"We have been consumed by the fires of hatred and rage. Enjoy your victory in this life, for I shall find you in the next."	),
...
--------------------------------------------------------------------
	...
	("LOC_PEDIA_LEADERS_PAGE_CVS_ASKIYA_QUOTE",		
	"A sword should never be allowed to rust."  	),
	
	("LOC_PEDIA_LEADERS_PAGE_CVS_ASKIYA_TITLE",		
	"Askiya"),
	
	("LOC_PEDIA_LEADERS_PAGE_CVS_ASKIYA_SUBTITLE",		
	"Askiya the Great, King of Songhai"	),
	
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_CAPSULE_BODY",		
	"If there is a lesson to be learned or indeed taught, Askiya's Songhai excels at both."),
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_DETAILED_BODY",		
	"Songhai is a versatile civilization that requires forward-planning to achieve their goals. The initial push for Askiya's Songhai should be a focus on [ICON_Religion] Religion, for founding one will not only help his scientific progress, but will keep cities in his empire Loyal with which Cavalry units will benefit from a free [ICON_Promotion] Promotion. While Askiya can excel in quests for Religious or Domination victories, it is in [ICON_Science] Science where his playstyle is complemented by Songhai's foundation for technological progress. Their unique Campus replacement, the Karambungo, provides the city's outgoing [ICON_TradeRoute] Trade Routes +1 [ICON_Science] Science for each Scientific building within it, making it crucial for cities to become centers of Trade and Scientific advancement. With [ICON_Gold] Gold primarily coming from [ICON_TradeRoute] Trade and well-placed infrastructure along rivers, Songhai are able to spend their riches on the pursuit of many victory types. However, it is through Trade and Religion that Askiya's Songhai will ultimately pave the road toward a Scientific victory."	),

	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_1",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_2",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_3",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_4",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_5",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_6",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_7",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_8",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_9",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_10",		
	...
	("LOC_PEDIA_LEADERS_PAGE_LEADER_CVS_ASKIYA_CHAPTER_HISTORY_PARA_11",		
	...
	("LOC_PEDIA_BUILDINGS_PAGE_BUILDING_CVS_ASKIYA_UI_CHAPTER_HISTORY_PARA_1",	
	"With the removal of Sonni Baru in 1493, the path toward the full acceptance of Islam by the Songhai was set. Askiya, who led Songhai from 1493 to 1538, not only practiced the faith but also governed from an Islamic framework. The appointment of Islamic judges demonstrated respect for the religion's principles of justice. From 1494 to 1497, Askiya made a pilgrimage to Mecca. During his stay, the Songhai ruler established official diplomatic relations between Gao and Mecca. Understanding the importance of culture and knowledge to the religion, he elevated the ulama, his Muslim scholars, in the public eye. The growth of Timbuktu, the home of African-Muslim scholarship, symbolizes the acceptance of Islam by the Songhai. Long suppressed by traditional rulers, the city reached its zenith under Askiya."	);
